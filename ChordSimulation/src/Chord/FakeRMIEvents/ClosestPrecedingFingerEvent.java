 ...
 * @author Simon Edänge
 */
public class ClosestPrecedingFingerEvent extends ProcessEvent
{
    public final ChordNode NODE_CALLER;
    public final ChordId NODE_TARGET;
    
    /**
     * 
     * @param caller The node who created this event (issuer).
     * @param target The node to use in this operation.
     */
    public ClosestPrecedingFingerEvent(ChordNode caller, ChordId target)
    {
        super();
        NODE_CALLER = caller;
        NODE_TARGET = target;
