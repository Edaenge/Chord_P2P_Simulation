 ...
 * @author Simon Edänge
 */
public class GetPredecessorEventRE extends ReturnEvent
{
     ...
     */
    public GetPredecessorEventRE(ChordNode targetNode, ChordNode replier)
    {
        super();
        this.NODE_REPLIER = replier;
        this.NODE_TARGET_REQUESTED = targetNode;
    }
