 ...
 * @author Simon Edänge
 */
public class PutReplicasEventRE extends ReturnEvent
{
    public final ChordNode NODE_REPLIER;
    public final boolean MESSAGE_REACHED;

    /**
     * 
     * @param replier The creator of this return event.
     * @param message_reached True if the message was reached and performed.
     */
    public PutReplicasEventRE(ChordNode replier, boolean message_reached)
    {
        this.NODE_REPLIER = replier;
        this.MESSAGE_REACHED = message_reached;
    }
