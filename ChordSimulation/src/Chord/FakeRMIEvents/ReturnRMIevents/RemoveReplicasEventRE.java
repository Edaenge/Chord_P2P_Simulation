 ...
 * @author Simon Edänge
 */
public class RemoveReplicasEventRE extends ReturnEvent
{
    final public ChordNode NODE_REPLIER;
    final public boolean REMOVED;

    /**
     * 
     * @param replier The creator of this return event.
     * @param removed True if replicas was removed.
     */
    public RemoveReplicasEventRE(ChordNode replier, boolean removed)
    {
